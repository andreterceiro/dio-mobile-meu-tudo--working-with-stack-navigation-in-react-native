...
Teacher accessed in the home page of [reactnavigation.org](http://reactnavigation.org) the button "Read docs". There he could see this menu related to types of navigations when clicked in **"Guides"**:
